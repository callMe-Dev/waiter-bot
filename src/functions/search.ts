...
export const search = (client: Client): void => {
    ...
    command(client, aliases, async (message: Message): Promise<void> => {
        ...
        try {
            ...
            if (search) {
                ...
                /** Loading */
                const embedLoading: MessageEmbed = new MessageEmbed().setTitle("Loading").setDescription("Searching for food...")
            ...
            const e: MessageEmbed = new MessageEmbed().setTitle("Error").setDescription(err.message as string)
            if (msgLoading) {
                msgLoading.edit(e)
            } else {
                message.reply(e)
